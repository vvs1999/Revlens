...
const colors = {
  primary: "#1F4E79", // Deep Navy - original blue from version 1
...
export function ImprovedGraphCarousel() {
  const [activeIndex, setActiveIndex] = useState(0)
  const charts = [
    { type: "bar", title: "Quarterly Sales", subtitle: "By Quarter", component: BarChart },
    { type: "horizontal-bar", title: "Product Performance", subtitle: "By Category", component: HorizontalBarChart },
    { type: "pie", title: "Revenue Distribution", subtitle: "By Product Category", component: PieChart },
    { type: "line", title: "Growth Trend", subtitle: "Last 12 Months", component: LineChart },
  ]
  ...
  return (
    <div className="relative h-[400px] w-full bg-white/80 backdrop-blur-sm rounded-xl shadow-sm overflow-hidden">
      {/* Progress bar */}
      ...
      <div className="p-6 h-full">
        ...
        <div className="h-[300px] relative">
          <AnimatePresence mode="wait">
            ...
            >
              {React.createElement(charts[activeIndex].component, {
                isActive: activeIndex === charts.findIndex((c) => c.type === charts[activeIndex].type),
              })}
            </motion.div>
          </AnimatePresence>
        </div>
